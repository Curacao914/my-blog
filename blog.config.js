...
const BLOG = {
  ...
  NOTION_PAGE_ID: '3062d404b0b281ca935bffae693c000a',
  ...
  // Content is normally cached; signed-in administrators can refresh a page on demand.
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 21600, // 更新缓存间隔 单位(秒)；默认每个页面有6小时的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Curacao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个对法律和非法律感兴趣的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'law-tech.dev', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Curacao, Blog', // 网站关键词 英文逗号隔开
