...
/* batch3: course folders and uniform settings actions */
.course-automation-settings .settings-actions,
.course-wechat-settings .settings-actions {
  align-items: center;
  gap: 9px;
}
.course-automation-settings .settings-actions .soft-button,
.course-wechat-settings .settings-actions .soft-button {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-height: 40px;
...
.course-library-toolbar .section-heading {
  margin: 0;
}
.course-library-toolbar .section-heading p,
.course-folder-view .section-heading p {
  margin: 5px 0 0;
  color: var(--muted);
  font-size: 11px;
}
.course-folder-search {
  display: grid;
  gap: 5px;
  width: min(280px, 100%);
  color: var(--muted);
...
.course-folder-card {
  ...
  color: var(--ink);
  background:
    linear-gradient(145deg, rgba(255,255,255,.72), rgba(220,233,223,.38));
  box-shadow:
    0 13px 32px rgba(24,54,43,.07),
...
.course-folder-card:hover {
  ...
  border-color: rgba(17,63,49,.18);
  box-shadow:
    0 18px 42px rgba(24,54,43,.1),
    inset 0 1px 0 rgba(255,255,255,.78);
}
.course-folder-card-icon {
  display: grid;
  place-items: center;
  width: 42px;
  height: 42px;
  ...
  color: var(--leaf);
  font-weight: 720;
  background: rgba(17,63,49,.09);
}
.course-folder-card-copy {
  display: grid;
  gap: 6px;
  min-width: 0;
}
.course-folder-card-copy strong {
  overflow: hidden;
  font-family: var(--display-serif);
  font-size: 19px;
  font-weight: 600;
...
.course-folder-card-copy small {
  color: var(--muted);
  font-size: 10px;
}
.course-folder-card-copy em {
  width: fit-content;
  border-radius: 999px;
  padding: 4px 8px;
  color: var(--leaf);
  background: rgba(220,233,223,.68);
  font-size: 9px;
  font-style: normal;
}
.course-folder-card-meta {
  color: var(--quiet);
  font-size: 9px;
  white-space: nowrap;
}
.course-library-breadcrumbs {
  display: flex;
  align-items: center;
  gap: 8px;
  color: var(--muted);
...
.course-library-breadcrumbs button {
  border: 0;
  padding: 5px 0;
  color: var(--leaf);
  background: transparent;
...
.course-folder-view .course-job-list {
  min-height: 0;
  overflow: auto;
}
...
/* macos-system-v4-overrides:start */
:root{--system-menu-height:54px;--system-top-offset:86px;--system-bottom-offset:92px;--system-radius-lg:32px;--system-border:rgba(255,255,255,.68);--system-shadow:0 24px 80px rgba(24,63,50,.095)}#__next{min-height:100vh}.lawtech-public-page{min-height:100dvh;padding-top:var(--system-top-offset);padding-bottom:var(--system-bottom-offset)}.public-shell{width:min(1400px,calc(100vw - 44px));margin:0 auto}.system-app-window,.content-app-window,.tools-app-window,.about-app-window,.public-directory-window{position:relative;overflow:hidden;border:1px solid var(--system-border);border-radius:var(--system-radius-lg);background:radial-gradient(circle at 12% 0%,rgba(244,228,184,.28),transparent 32%),radial-gradient(circle at 92% 0%,rgba(226,237,241,.5),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.54),rgba(255,255,255,.22));box-shadow:var(--system-shadow),inset 0 1px 0 rgba(255,255,255,.78);backdrop-filter:blur(22px) saturate(1.08)}.system-window-chrome{display:flex;align-items:center;gap:8px;min-height:52px;padding:16px 18px 8px}.system-window-light{width:12px;height:12px;border-radius:50%;box-shadow:inset 0 1px 0 rgba(255,255,255,.32)}.system-window-light.red{background:#ff5f57}.system-window-light.yellow{background:#ffbd2e}.system-window-light.green{background:#28c840}.system-app-title{margin-left:14px;color:var(--leaf);font-size:10px;font-weight:820;letter-spacing:.26em;text-transform:uppercase}.desk-layout{width:min(1400px,calc(100vw - 44px));height:calc(100dvh - var(--system-top-offset) - var(--system-bottom-offset) + 22px);margin:0 auto;padding:0;display:grid;grid-template-columns:246px minmax(0,1fr);gap:22px;overflow:hidden}.desk-sidebar{position:relative!important;top:auto!important;height:100%;max-height:none!important;overflow:auto;border-color:rgba(255,255,255,.68)!important;background:rgba(255,255,255,.42)!important;box-shadow:0 18px 54px rgba(24,63,50,.08),inset 0 1px 0 rgba(255,255,255,.72)!important;scrollbar-width:thin}.desk-main{height:100%;overflow:hidden}.desk-topbar{position:relative!important;top:auto!important;min-height:58px;margin-bottom:14px;border-color:rgba(255,255,255,.7)!important;border-radius:28px!important;background:rgba(255,255,255,.42)!important}.desk-page{width:100%!important;height:calc(100% - 72px);margin:0!important;overflow:auto;border:1px solid rgba(255,255,255,.68)!important;border-radius:34px!important;background:radial-gradient(circle at 82% 0%,rgba(226,237,241,.44),transparent 36%),linear-gradient(145deg,rgba(255,255,255,.5),rgba(255,255,255,.18))!important;box-shadow:0 24px 80px rgba(24,63,50,.085),inset 0 1px 0 rgba(255,255,255,.76)!important;backdrop-filter:blur(22px) saturate(1.08)}.desk-nav a{display:grid!important;grid-template-columns:18px minmax(0,1fr) auto;align-items:center;gap:10px;border:1px solid rgba(255,255,255,.48);border-radius:18px!important;background:rgba(255,255,255,.2)}.desk-nav a:hover,.desk-nav a[aria-current=page]{transform:none!important;color:var(--ink)!important;background:rgba(255,255,255,.52)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.62)}.about-profile-settings textarea{width:100%;min-height:420px;border:1px solid rgba(23,35,29,.12);border-radius:22px;padding:16px;background:rgba(255,255,255,.58);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;line-height:1.6;color:var(--ink)}@media(max-width:920px){.lawtech-public-page{padding-top:112px}.public-shell{width:min(100% - 24px,760px)}.desk-layout{width:min(100% - 24px,760px);height:auto;min-height:calc(100dvh - 160px);grid-template-columns:1fr;overflow:visible}.desk-sidebar{display:none}.desk-main{height:auto;overflow:visible}.desk-page{height:auto;min-height:60dvh}}
/* macos-system-v4-overrides:end */


/* macos-system-v5-repair:start */
.public-header.system-menu-bar{min-height:50px!important;padding-top:6px!important;padding-bottom:6px!important;overflow:visible!important}.public-header.system-menu-bar .system-menu-search{height:34px}.public-header.system-menu-bar .public-nav a{padding:8px 15px!important}.system-dock{position:fixed!important;left:50%!important;bottom:16px!important;z-index:2400!important;transform:translateX(-50%)!important;display:flex!important;align-items:center!important;gap:8px!important;width:auto!important;border:1px solid rgba(255,255,255,.72)!important;border-radius:23px!important;padding:7px 9px!important;background:linear-gradient(180deg,rgba(255,255,255,.5),rgba(255,255,255,.2))!important;box-shadow:0 22px 58px rgba(24,63,50,.12),inset 0 1px 0 rgba(255,255,255,.76)!important;backdrop-filter:blur(24px) saturate(1.12)!important}.system-dock-item{position:relative!important;width:42px!important;height:42px!important;display:grid!important;place-items:center!important;border:1px solid rgba(255,255,255,.66)!important;border-radius:15px!important;padding:0!important;color:var(--leaf)!important;background:linear-gradient(135deg,rgba(255,255,255,.38),rgba(255,255,255,.12))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.66)!important;transition:transform .18s cubic-bezier(.2,1.22,.28,1),border-radius .18s ease,background .18s ease!important;white-space:normal!important;font-size:0!important;line-height:1!important}.system-dock-item:hover,.system-dock-item.is-active{transform:translateY(-4px) scale(1.08)!important;border-radius:18px!important;background:rgba(255,255,255,.4)!important}.system-dock-item svg{width:18px!important;height:18px!important}.system-dock-item span{position:absolute!important;bottom:calc(100% + 8px)!important;left:50%!important;transform:translateX(-50%) translateY(3px)!important;opacity:0!important;pointer-events:none!important;white-space:nowrap!important;border:1px solid rgba(255,255,255,.7)!important;border-radius:999px!important;padding:5px 8px!important;color:var(--ink)!important;background:rgba(255,255,255,.52)!important;box-shadow:0 10px 24px rgba(24,63,50,.08)!important;backdrop-filter:blur(16px)!important;font-size:11px!important;line-height:1.2!important;transition:opacity .15s ease,transform .15s ease!important}.system-dock-item:hover span{opacity:1!important;transform:translateX(-50%)!important}.system-dock-item:after{content:'';position:absolute;left:50%;bottom:-7px;width:4px;height:4px;border-radius:50%;transform:translateX(-50%);background:var(--leaf);opacity:0}.system-dock-item.is-active:after{opacity:.55}.home-system-v5-repaired{overflow:hidden!important}.home-system-v5-repaired .home-desktop-grid{height:calc(100dvh - 178px);min-height:610px;align-items:stretch}.home-system-v5-repaired .home-main-window{height:100%;min-height:0}.home-system-v5-repaired .home-canvas{min-height:0;height:100%}.home-system-v5-repaired .home-side{align-items:stretch}.home-system-v5-repaired .recent-widget{min-height:230px}.home-system-v5-repaired .reel-window{height:128px!important}.home-system-v5-repaired .reel-card{height:116px!important}.home-system-v5-repaired .signature-wrap{margin-top:auto;display:flex;justify-content:center;padding:4px 0 0}.desk-layout{grid-template-columns:286px minmax(0,1fr)!important;gap:24px!important}.desk-sidebar{min-width:286px!important;padding-left:18px!important;padding-right:18px!important}.desk-brand-row{grid-template-columns:minmax(0,1fr) auto!important}.desk-nav a span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.desk-page{overflow:auto!important}.profile-editor-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.profile-editor-card{display:grid;gap:12px;border:1px solid rgba(255,255,255,.62);border-radius:24px;padding:16px;background:rgba(255,255,255,.36);box-shadow:inset 0 1px 0 rgba(255,255,255,.66)}.profile-editor-card.is-wide{grid-column:1/-1}.profile-editor-card h4{margin:0;font-family:var(--display-serif);font-size:24px;font-weight:620}.profile-field{display:grid;gap:6px}.profile-field span{color:var(--quiet);font-size:10px;letter-spacing:.08em;text-transform:uppercase}.profile-field input,.profile-field textarea{width:100%;border:1px solid rgba(23,35,29,.12);border-radius:14px;padding:10px 12px;color:var(--ink);background:rgba(255,255,255,.56);outline:none}.profile-field textarea{min-height:86px;resize:vertical;line-height:1.65}.profile-skill-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.profile-editor-actions{display:flex;align-items:center;gap:10px;margin-top:16px}.profile-editor-actions button{border:0;border-radius:999px;padding:9px 13px;color:#fff8e6;background:var(--leaf);cursor:pointer}.profile-editor-actions button:nth-child(2){color:var(--leaf);background:rgba(255,255,255,.58)}.profile-editor-actions span{color:var(--muted);font-size:12px}@media(max-width:980px){.profile-editor-grid,.profile-skill-grid{grid-template-columns:1fr}.desk-layout{grid-template-columns:1fr!important}.desk-sidebar{display:none}}
/* macos-system-v5-repair:end */
