...
export function PublicDirectoryPage({
  ...
  return <>
    ...
    <main className='lawtech-public-page public-directory-page'>
      ...
      <style jsx>{`
        /* public-directory-surface-v1: lighter archive/category/tag directory */
        .public-directory-hero { display:flex; align-items:end; justify-content:space-between; gap:24px; padding:46px 0 24px; }
        .public-directory-hero > div { max-width:780px; }
        .public-directory-hero h1 { margin:7px 0 8px; font-family:var(--display-serif); font-size:clamp(40px,5.8vw,62px); font-weight:600; letter-spacing:-.055em; }
        ...
        .public-directory-hero nav a { border:1px solid rgba(17,63,49,.08); border-radius:999px; padding:6px 10px; color:var(--green); background:rgba(255,255,255,.36); font-size:10px; }
        .public-directory-selected,
        .public-directory-groups { border:1px solid rgba(255,255,255,.66); border-radius:20px; padding:15px; background:rgba(255,255,255,.5); box-shadow:0 16px 44px rgba(24,63,50,.045),inset 0 1px 0 rgba(255,255,255,.82); backdrop-filter:blur(14px); }
        ...
        .public-directory-groups { display:grid; gap:8px; }
        details { overflow:hidden; border:1px solid rgba(17,63,49,.065); border-radius:16px; background:rgba(255,255,255,.4); }
        ...
        .public-directory-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(230px,1fr)); gap:9px; padding-top:12px; }
        ...
        .public-directory-foot { display:flex; justify-content:flex-end; margin:22px 0 56px; padding:0 8px; color:var(--muted); }
