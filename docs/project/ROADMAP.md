...
- [x] CI PR #9 checks 与 merge commit `6db4e8a8e4b216f95b1b5f330905a084929ae78d` 已记录；纠正 PR #10 merge `f5f96ca71ead7c70606933ee1095f725630fe7ca` 已将 required validation 与 GHCR 发布解耦；本记录 PR 同时验证纯文档 fast-success。
