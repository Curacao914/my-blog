...
const SYSTEM_INSTRUCTION = [
  ...
  'Scope semantics: single means one target; matching means a filtered lookup that may return candidates; list means a broad collection; selected means an ordinal or contextual selection; all_unread means the complete unread set; none means no resource target.',
